//Tipos de Datos
//Jamas tildes ni ñ, solo en los strings. Todo esta en ingles
...
//
console.log("Hola " + nombre + " tu edad es: " + edad + " tu sueldo es: " + sueldo + " tienes hijos? " + hijos );

//+ para concatenar , cuando hay string
